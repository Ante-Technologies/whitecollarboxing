...
export const metadata: Metadata = {
  title: "Privacy",
  description:
    "Here at whitecollarboxing.org we respect your privacy and are completely committed to protecting any information shared with us.",
  ...
  return (
    <PageWrap title="Privacy">
      <div className="max-w-4xl space-y-6 text-base leading-relaxed text-foreground">
        <p>
          Here at whitecollarboxing.org we respect your privacy and are completely
        ...
        <p>
          The whitecollarboxing.org Web Site is structured so you can visit us on
