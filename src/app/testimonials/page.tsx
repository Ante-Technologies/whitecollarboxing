...
export const metadata: Metadata = {
  title: "Testimonials",
  description:
    "Read what organisers and participants say about running a fundraising White Collar Boxing Fight Night with Whitecollarboxing.org.",
...
const testimonials = [
  {
    ...
    body: [
      ...
      "You assisted in bringing our novice boxers from the anxiousness of their first training session to performing heroically in this charity boxing event for St. Johns Ward, in Crumlin Childrens Hospital. I am delighted to report that we are closing in on achieving 100K for St. Johns Ward. You and everyone in whitecollarboxing.org can be very proud of the huge part you played in this wonderful achievement.",
  ...
  },
  {
    ...
    body: [
      "I worked with Cathal and Whitecollarboxing.org in 2010 and 2011. Together we organised two boxing events to raise funds for Outreach Moldova (ORM). The \"ORM Fight Night\" events were hugely successful and they both raised €15k for the charity.",
